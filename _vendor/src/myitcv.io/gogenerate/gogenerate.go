...
// OutputFlag defines a new flag "outpkg:"+key that can accept a list of
// package specifications that represent output targets above and beyond the
// default of self.
func OutputFlag(key string) *outputs {
	if outputsSet[key] {
		panic(fmt.Errorf("already defined output flag for key %q", key))
	}
